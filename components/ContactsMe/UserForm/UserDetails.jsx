...
const UserDetails = (props) => {
  ...
  return (
    <div className={styles.animateChat}>
      <span className={styles.titleUserDetails}>
        🦹‍♀️ Tell a bit about yourself
      </span>
        ...
        <input
          ...
          className={
            formik.errors.fullName && formik.touched.fullName
              ? [styles.user_input, styles.inputError].join(" ")
              : styles.user_input
          }
        />
        {formik.errors.fullName && formik.touched.fullName ? (
        ...
        <input
          ...
          className={
            formik.errors.phoneNumber && formik.touched.phoneNumber
              ? [styles.user_input, styles.noSpin, styles.inputError].join(" ")
              : [styles.user_input, styles.noSpin].join(" ")
          }
        />
        {formik.errors.phoneNumber && formik.touched.phoneNumber ? (
      ...
      <div className={styles.navigation}>
        ...
        <button
          disabled={
            formik.errors.fullName || formik.errors.email ? true : false
          }
